...
public class BuildGraph{
  ...
  public static String generate(int v, int e, int min, int max, String filename) {
    ...
    private static String graphBuilder(String fileName, String directory, int vertices, int dense, int maxCapacity, int minCapacity)
    {
 ...
 public static void main(String[] args){
                generate(30, 30, 0, 250, "rand_input1.txt");
				generate(30, 30, 50, 250, "rand_input2.txt");
				generate(30, 30, 100, 250, "rand_input3.txt");
				generate(30, 30, 150, 250, "rand_input4.txt");
				generate(30, 30, 200, 250, "rand_input5.txt");
				generate(10, 10, 10, 100, "rand_input6.txt");
				generate(50, 50, 10, 100, "rand_input7.txt");
				generate(75, 75, 10, 100, "rand_input8.txt");
				generate(100, 100, 10, 100, "rand_input9.txt");
				generate(125, 125, 10, 100, "rand_input10.txt");
